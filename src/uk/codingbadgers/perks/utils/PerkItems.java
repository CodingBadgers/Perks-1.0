...
public class PerkItems {
    ...
    static {
        ...
        //1.4 Blocks & Items
        items.add(new PerkItem("Command Block", new String[][]{{"comm"}}, Material.COMMAND));
        items.add(new PerkItem("Beacon Block", new String[][]{{"beac"}}, Material.BEACON));
        items.add(new PerkItem("Anvil", new String[][]{{"anv"}}, Material.ANVIL));
        items.add(new PerkItem("Flower Pot Block", new String[][]{{"blo", "flow", "pot"}}, Material.FLOWER_POT));
        items.add(new PerkItem("Flower Pot", new String[][]{{"flow", "pot"}}, Material.FLOWER_POT_ITEM));
        items.add(new PerkItem("Cobblestone Wall", new String[][]{{"cob", "wall"}}, Material.COBBLE_WALL));
        items.add(new PerkItem("Item Frame", new String[][]{{"fram"}}, Material.ITEM_FRAME));
        items.add(new PerkItem("Skeleton Skull", new String[][]{{"skel", "skul"}, {"skel", "hea"}}, Material.SKULL_ITEM));
        items.add(new PerkItem("Wither Skeleton Skull", new String[][]{{"with", "skul"}, {"with", "hea"}}, Material.SKULL_ITEM, (short) 1));
        items.add(new PerkItem("Zombie Head", new String[][]{{"zomb", "hea"}, {"zomb", "skul"}}, Material.SKULL_ITEM, (short) 2));
        items.add(new PerkItem("Human Head", new String[][]{{"huma", "skul"}, {"huma", "hea"}}, Material.SKULL_ITEM, (short) 3));
        items.add(new PerkItem("Creeper Head", new String[][]{{"cree", "skul"}, {"cree", "hea"}}, Material.SKULL_ITEM, (short) 4));
        items.add(new PerkItem("Carrot", new String[][]{{"carr"}}, Material.CARROT_ITEM));
        items.add(new PerkItem("Carrot Block", new String[][]{{"blo", "carr"}}, Material.CARROT));
        items.add(new PerkItem("Carrot on a Stick", new String[][]{{"sti", "carr"}}, Material.CARROT_STICK));
        items.add(new PerkItem("Potato", new String[][]{{"pota"}}, Material.POTATO_ITEM));
        items.add(new PerkItem("Potato Block", new String[][]{{"blo", "pota"}}, Material.POTATO));
        items.add(new PerkItem("Wood Button", new String[][]{{"woo", "butto"}}, Material.WOOD_BUTTON));
        items.add(new PerkItem("Pumpkin Pie", new String[][]{{"pie"}, {"pumpk", "pie"}}, Material.PUMPKIN_PIE));
        items.add(new PerkItem("Potion of Invisibility", new String[][] {{"pot", "invi"}}, Material.POTION, (short) 8206));
