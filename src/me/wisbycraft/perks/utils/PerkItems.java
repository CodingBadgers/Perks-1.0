...
public class PerkItems {
    ...
    static {
        ...
        items.add(new PerkItem("Sticky Piston", new String[][]{{"stic", "pis"}}, Material.PISTON_STICKY_BASE));
        ...
        items.add(new PerkItem("Piston", new String[][]{{"pist"}}, Material.PISTON_BASE));
        ...
        items.add(new PerkItem("Glass Pane", new String[][]{{"thin", "gla"}, {"pane"}, {"gla", "pane"}}, Material.THIN_GLASS));
